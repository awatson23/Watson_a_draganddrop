(() => {
	...
	function createPuzzlePieces(pictureIndex) {
		//generate images (music icons) here -> need to make 4 (top left, right, bottom left, right)
	...
	// drag and drop functionality / music icons will have this added
	//this is a 3-step process
	//1. handle the dragon event
	//2. handle the dragover event
	//3. handle the drop event
	//
	//dragging sets some data refernece (an audio track name, image source, etc)
